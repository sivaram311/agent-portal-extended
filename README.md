...
**Status:** `v0.4.4-sso-session-fix-dev` (versionCode 14). SSO Custom Tabs package-visibility fix; stop wiping tokens on transient refresh failures (false â€œsession expiredâ€ while TTL still showed ~14m).
